        ...
        if (RedBall_lower == [] and RedBall == []):
            ...
            if (Goal != []):
                ...
                if (Goal[0] < 280 or Goal[0] > 360):
                    print "Not Centered"
                    if (self.freePath(Enemy, Goal[0] - 25, Goal[0] + 25)):
                        print "Free Path eventually"
                        if (Goal[0] < 290):
                            self.player.walk2(0.0, -0.5, .1)
                        else:
                            self.player.walk2(0.0, 0.5, -.1)
                    elif (not self.freePath(Enemy, Goal[0] - 25, Goal[0] + 25)):
                        print "Blocked path in future"
                        if (Goal[0] < 200):
                            self.player.walk2(0.0, -0.5, .1)
                        elif (Goal[0] > 290):
                            self.player.walk2(0.0, 0.5, -.1)
                            ...
                            if (RedBall_lower[1] <= 460):
                                ...
                                self.player.walk2(.3, 0.0,-theta*0.2)
                            else:
                                print "Kicking"

                                if (RedBall_lower[0] < 320):
                                    self.player.killWalk()
                                    self.player.leftKick(1.0, 1.3, 2.2)
                                else:
                                    self.player.killWalk()
                                    self.player.leftKick(1.0, 1.3, 2.2)
                    else:
                    ...
                    if (self.freePath(Enemy, 290, 360)):
                        ...
                        if (RedBall_lower[1] <= 460):
                            ...
                            if (RedBall_lower[0] < 320):
                                ...
                                self.player.killWalk()
                                self.player.rightKick(1.0, 1.1, 2.3)
                    else:
                        print "Centered & Blocked"
                        if (Goal[0] < 230):
                            self.player.walk2(0.0, -0.5, .1)
                        else:
                            self.player.walk2(0.0, 0.5, -.1)
